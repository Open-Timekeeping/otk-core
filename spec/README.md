...
- Terminology and glossary (detection, hit, crossing, timing point, detector, transponder, entrant, timebase, OTK Protocol layers, downlink, etc.).
...
- Bidirectional / downlink architecture (fabric-to-subject telemetry, asymmetric device capabilities, CAN-out to in-vehicle dashboards). See [downlink.md](downlink.md).
